 ...
 */
   ...
   */
    ...
    #define HAS_BED_PROBE HAS_Z_PROBE
  #endif
   ...
   */
    ...
    #define PROBE_SELECTED (ENABLED(Z_PROBE_FIX_MOUNTED) || ENABLED(Z_PROBE_MECHANICAL) || HAS_Z_ENDSTOP_SERVO || ENABLED(Z_PROBE_SLED))
    #define PROBE_PIN_CONFIGURED (HAS_Z_PROBE || HAS_Z_MIN)
