 ...
 */
  ...
  #define HAS_POWER_CONSUMPTION_SENSOR (defined(POWER_CONSUMPTION) && PIN_EXISTS(POWER_CONSUMPTION_PIN))
  ...
  #define HAS_E0E1 (PIN_EXISTS(E0E1_CHOICE_PIN))
  #define HAS_E0E2 (PIN_EXISTS(E0E2_CHOICE_PIN))
  #define HAS_E0E3 (PIN_EXISTS(E0E3_CHOICE_PIN))
  #define HAS_E0E4 (PIN_EXISTS(E0E4_CHOICE_PIN))
  #define HAS_E1E3 (PIN_EXISTS(E1E3_CHOICE_PIN))
