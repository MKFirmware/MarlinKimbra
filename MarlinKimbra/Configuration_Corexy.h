...
#define HOMING_FEEDRATE {70*60, 70*60, 2*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT     {80.54,80.54,1600,495,495,495,495}    // X, Y, Z, E0, E1, E2, E3
