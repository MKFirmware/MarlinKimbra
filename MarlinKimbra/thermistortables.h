...
const short temptable_13[][2] PROGMEM = {
  {short(20.04) * OVERSAMPLENR, 300},
  {short(23.19) * OVERSAMPLENR, 290},
  {short(26.71) * OVERSAMPLENR, 280},
  {short(31.23) * OVERSAMPLENR, 270},
  {short(36.52) * OVERSAMPLENR, 260},
  {short(42.75) * OVERSAMPLENR, 250},
  {short(50.68) * OVERSAMPLENR, 240},
  {short(60.22) * OVERSAMPLENR, 230},
  {short(72.03) * OVERSAMPLENR, 220},
  {short(86.84) * OVERSAMPLENR, 210},
  {short(102.79) * OVERSAMPLENR, 200},
  {short(124.46) * OVERSAMPLENR, 190},
  {short(151.02) * OVERSAMPLENR, 180},
  {short(182.86) * OVERSAMPLENR, 170},
  {short(220.72) * OVERSAMPLENR, 160},
  {short(316.96) * OVERSAMPLENR, 140},
  {short(447.17) * OVERSAMPLENR, 120},
  {short(590.61) * OVERSAMPLENR, 100},
  {short(737.31) * OVERSAMPLENR, 80},
  {short(857.77) * OVERSAMPLENR, 60},
  {short(939.52) * OVERSAMPLENR, 40},
  {short(986.03) * OVERSAMPLENR, 20},
  {short(1008.7) * OVERSAMPLENR, 0}
